  ...
  return (
    <>
      ...
      >
        ...
        <p className="text-black text-lg sm:text-xl font-bold font-lora m-3 text-center max-w-4xl p-4 ">
          Innovation Excellence Reliability and Dedicated Services
        </p>
        <span className="text-black text-sm sm:text-sm font-bold font-lora  text-right max-w-4xl absolute bottom-0 right-0 m-3">
